...
class ConfigAdapterTest extends \Test\TestCase {
	...
	public function testGetPersonalMountsUserPlaceholder() {
		$this->session->method('exists')->with('altloginname')->willReturn(false);
	...
	public function testGetPersonalMountsUserPlaceholderAltLogin() {
		$this->session->method('exists')->with('altloginname')->willReturn(true);
		$this->session->method('get')->with('altloginname')->willReturn('altlogin1');
